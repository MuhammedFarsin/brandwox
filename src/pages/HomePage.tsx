...
import { ArrowRight, Sparkles, Users, Award, TrendingUp, ChevronRight, Star, Quote, Zap, Target, Globe, Shield } from 'lucide-react';
  ...
  const features: Feature[] = [
    {
      ...
      description: 'Expert guidance tailored to meet your unique brand needs with precision and innovation.',
    },
    {
      icon: <Zap className="h-8 w-8" />,
      title: 'Bespoke Software Solutions',
      description: 'Custom software solutions that reflect your brand identity and drive exceptional performance.',
    },
    {
      icon: <Globe className="h-8 w-8" />,
      title: 'Digital Marketing Excellence',
      description: 'Innovative campaigns that captivate audiences and deliver measurable, impactful results.',
    },
    {
      icon: <Shield className="h-8 w-8" />,
      title: 'Secure & Scalable Solutions',
      description: 'Robust, future-proof digital solutions built with security and scalability at their core.',
    },
  ];
  ...
  const testimonials: Testimonial[] = [
    {
      ...
      content: 'Brandwox transformed our digital presence completely. Their strategic approach helped us increase engagement by 300%.',
      rating: 5,
    },
    {
      id: 2,
      ...
      content: 'The custom software solution exceeded all expectations. It improved our efficiency by 40% and streamlined operations.',
      rating: 5,
    },
    {
      id: 3,
      ...
      content: 'Working with Brandwox was a game-changer. We achieved a 250% increase in sales within just 6 months.',
      rating: 5,
    },
  ];
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className={`text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold mb-6 transition-all duration-1000 delay-400 ${
              heroInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}>
            ...
            <p className={`text-lg sm:text-xl lg:text-2xl text-gray-600 mb-8 leading-relaxed max-w-3xl mx-auto transition-all duration-1000 delay-600 ${
              heroInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}>
              Empower Your Brand with Innovative Digital Solutions Tailored for Success
            </p>

            <div className={`flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 transition-all duration-1000 delay-800 ${
              heroInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}>
              <Link
                to="/contact"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              At Brandwox, we redefine the digital experience for businesses worldwide. Our innovative digital 
              services combine cutting-edge technology with creative excellence to deliver exceptional results.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Join the ranks of successful businesses who have transformed their digital presence with Brandwox's luxury solutions.
          </p>
          <Link
            to="/contact"
