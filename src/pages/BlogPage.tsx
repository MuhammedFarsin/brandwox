  ...
  const featuredPosts = [
    {
      ...
      excerpt: "Discover how elite brands craft digital experiences that command premium pricing and loyalty through strategic design psychology.",
      date: "2024-03-15",
      readTime: "8 min",
    ...
    },
    {
      ...
      excerpt: "Key techniques to translate physical luxury into digital experiences that resonate with affluent audiences.",
      date: "2024-03-10",
      readTime: "6 min",
      category: "Web Design",
    ...
    },
    {
      ...
      excerpt: "Case studies of successful luxury brands that mastered the online transition without losing exclusivity.",
      date: "2024-03-05",
      readTime: "10 min",
  ...
  const recentPosts = [
    {
      ...
      excerpt: "How font selection impacts perceived value and brand authority in the luxury space.",
      date: "2024-02-28",
      readTime: "5 min",
    ...
    },
    {
      ...
      excerpt: "Less is more: How strategic minimalism creates premium digital experiences.",
      date: "2024-02-20",
      readTime: "7 min",
      category: "Web Design",
    ...
    },
    {
      ...
      excerpt: "Selecting the perfect palette to convey exclusivity and sophistication.",
      date: "2024-02-15",
      readTime: "6 min",
      category: "Brand Strategy",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-600">
            Expert perspectives on luxury branding, digital innovation, and creating exceptional online experiences.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                ...
                {featuredPosts.map((post, index) => (
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 p-6 sm:p-8 z-20 w-full">
                      ...
                      <p className="text-white/90 mb-3 text-sm sm:text-base">{post.excerpt}</p>
                ...
                {featuredPosts.map((_, index) => (
                  <button
                    ...
                    className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full transition-all ${
                      index === currentFeaturedIndex ? 'bg-blue-600 w-4 sm:w-6' : 'bg-gray-300'
                    }`}
                    ...
                    <div className="overflow-hidden rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 h-full">
                      <div className="p-4 sm:p-6">
                        ...
                        <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">
                          <Link to={`/insights/${post.slug}`} className="hover:text-blue-600 transition-colors">
                            {post.title}
                          </Link>
                        </h3>
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          >
                            Read <ChevronRight className="h-3 w-3 sm:h-4 sm:w-4 ml-1" />
                          </Link>
                        </div>
                      </div>
                    </div>
          ...
          <div className="lg:w-1/3 mt-8 lg:mt-0">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-4 sm:p-6 border border-blue-100">
              <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-2 sm:mb-3">Subscribe to Insights</h3>
              <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4">
                Get our latest articles and case studies delivered to your inbox.
              </p>
              <div className="flex">
                <input 
                  type="email" 
