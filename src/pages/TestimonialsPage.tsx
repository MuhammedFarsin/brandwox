  ...
  const testimonials = [
    {
      ...
      name: "John Carter",
      role: "Owner",
      company: "Carter Auto Sales, London",
      image:
        "https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=400",
      rating: 5,
      content:
        "Brandwox built us a fast, modern website that gets us real car buyer leads every week. We saw 5x more messages since launch!",
      project: "Website + Lead Funnel Setup",
    },
    {
      id: 2,
      name: "Sophia Evans",
      role: "Marketing Manager",
      company: "DriveSmart Motors, Manchester",
      image:
        "https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=400",
      rating: 5,
      content:
        "Our Facebook ads managed by Brandwox brought consistent inquiries. Their strategy is data-driven and transparent.",
      project: "Facebook Ads Management",
    },
    {
      id: 3,
      name: "Liam Patel",
      ...
      rating: 5,
      content:
        "Before working with Brandwox, we struggled to get leads from our site. Now, our landing page converts like crazy!",
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1
              className={`text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 transition-all duration-1000 delay-400 ${
                heroInView
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-10"
              }`}
            >
              <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent">
               How Small Businesses Grow with Brandwox
              </span>
            </h1>

            <p
              className={`text-lg sm:text-xl lg:text-2xl text-gray-600 mb-8 leading-relaxed transition-all duration-1000 delay-600 ${
                heroInView
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-10"
              }`}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <div
                  className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${stat.color} text-white rounded-xl mb-4 group-hover:scale-110 transition-transform duration-300`}
                >
                  {stat.icon}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              transformative power of our digital solutions
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
            Want More Leads Like Our Clients?
          </h2>
          <p className="text-lg sm:text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            We help UK used car dealers and small businesses get 10–20 more buyer inquiries every month.
          </p>
